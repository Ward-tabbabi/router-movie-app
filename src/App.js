...
import MovieDet from "./screens/MovieDet";
...
function App() {
  const [movies, setMovies] = useState([
    ...
    },
    {
      ...
      rating: 5,
      trailer: "https://www.youtube.com/embed/v7v1hIkYH24",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      rating: 5,
      trailer: "https://www.youtube.com/embed/S8CalSQJoYY",
    },
  ]);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/Movie"
          element={<MovieList movies={movies} text={text} />}
        />
        <Route path="/Movie/:id" element={<MovieDet movies={movies} />} />
